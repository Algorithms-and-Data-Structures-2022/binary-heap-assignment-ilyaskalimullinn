...
**Фамилия и Имя**: Калимуллин Ильяс

## 2. Описание задания

Реализуйте структуры данных "Двоичная куча" в файлах:
- [_src/min_binary_heap.cpp_](src/min_binary_heap.cpp)
- [_include/assignment/min_binary_heap.hpp_](include/assignment/min_binary_heap.hpp)
